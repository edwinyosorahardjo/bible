...
var JsonBible = function(){
    ...
    // return array of bibles
    function loadAvailableBibles(){
        var dfd = $.Deferred();
        $.get(baseUrl + 'bibles.json').done(d =>{ 
            dfd.resolve(bibles = d);
        });
        return dfd.promise();
    }

    function setBible(bibleParam){
        bible = bibleParam;
    }
    ...
    function getBooks(callback){
        var dfd = $.Deferred();
        $.when(get(model.bible.dbpath + '/' + 'books.json')).then(d =>{ 
            dfd.resolve(books = d);
        });
        return dfd.promise();
    }
    ...
    function getPassages(book, chapter){
        var dfd = $.Deferred();
        $.when(get(bible.dbpath + '/' + book + '_' + chapter + '.json')).then(d =>{ 
            dfd.resolve(chapter = d);
        });
        return dfd.promise();
    }
    ...
    return {
        ...
        Bible: () => bible,
        Books: () => books,
        LoadAvailableBibles: loadAvailableBibles,
        GetBooks: getBooks,
